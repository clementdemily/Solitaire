 ...
 * \date octobre 2013
 *
 * Représentation dans une File chainée
 */
...
namespace tp
{
	...
	*  se fait dans une File simplement chaînée.
	*/
	template <typename T>
	class File {
	public:
	...
	private:		
		...
		*  pour implémenter une File doublement chaînée.
		*/
		...
		class Noeud{	
		public:
			T m_el;			/*!<L'élément de base de la File*/
		...
		elem m_debut;				/*!<Pointeur vers le premier noeud de la File*/
		int m_cpt;
